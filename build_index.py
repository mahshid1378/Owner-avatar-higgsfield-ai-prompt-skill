...
This script is the single authority for both:
  python3 build_index.py            # regenerate INDEX.md (also runs checks)
  python3 build_index.py --check    # verify only; write nothing (CI / validate.py)
...
def build_index_text() -> str:
    lines = [
        ...
        "<!-- Regenerate: python3 build_index.py   Verify: python3 build_index.py --check -->",
        "",
